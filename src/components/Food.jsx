...
const filterPrice = (price) => {
            ...
            <div className='flex flex-col lg:flex-row justify-between'>
                ...
                <div>
                    ...
                    <div>
                        ...
                        <button onClick={() => filter('chicken')} className='m-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white'>
                            Chicken
                        </button>
                    </div>
                </div>
 ...
 {/* Filter Price */}
                ...
                <div>
                    ...
                    <div>
                        <button onClick={() => filterPrice('$')} className='mr-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white'>
                            $
                        </button>
                        <button onClick={() => filterPrice('$$')} className='mr-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white'>
                            $$
